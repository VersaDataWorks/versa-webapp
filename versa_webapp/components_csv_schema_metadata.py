...
def build_components(session_manager):
    ...
    with session_manager.uictx("csm") as _ctx:
        with session_manager.uictx("stats") as _statsctx:
            ...
            oj.Subsection_("section", heading_text="Stats", content_=_statsctx.stataccord)
        ...
        if appstate.metadata_report.header_lines:
            ...
            oj.Subsection_("headers", heading_text="Header Lines", content_=_ctx.headeraccord)
        else:
            oj.Subsection_("headers", heading_text="Header Lines", content_=oj.Span_(
        ...
        with session_manager.uictx("samples") as _samplesCtx:
            ...
            oj.Subsection_("section", heading_text="Row Samples", content_=_samplesCtx.samplesaccord)
